...
namespace PSP03_Socket_TCP
{
    internal class Servidor
    {
        ...
        private void FuncionCliente()
        {
            ...
            Socket handler = null;
            int connectionCount = 0; // Variable contadora de conexiones
            ...
            try
            {
                ...
                //Quedamos a la escucha de un máximo de peticiones simultaneas de cliente de 5 
                listener.Listen(5);
                ...
                while (true)
                {
                    ...
                    connectionCount++; // Incrementar la variable contadora
        ...
        //El siguiente método tiene como objetivo realizar la gestión del menú con el usuario.
        //@handler: Se recoge el objeto socket creado para la comunicación con el cliente.
        private void GestionMenu(Socket handler)
        {
            ...
            while (!salir)
            {
                ...
                switch (data)
                {
                    ...
                    case "4":
                        data = String.Empty;
                        salir = true;
                        Console.WriteLine("Un Cliente se sale de la aplicación. Agur.");
                        break;
                    default:
